...
#Aplications
APLICACIONES="libreoffice firefox-esr gimp gparted mc matchbox-keyboard rpi-imager audacious realvnc-vnc-viewer nmap crunch zip unar macchanger gnome-screenshot exfat-fuse exfat-utils ntfs-3g"
